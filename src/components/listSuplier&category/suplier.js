...
import ModalSuplier from "./modal/addSuplier";
import EditSuplier from "./modal/editSuplier";
...
const ListSuplier = (theme) => {
  const [idSuplier, setIdSuplier] = React.useState();
  ...
  const handleDelete = async () => {
    const response = await API.delete(`/deleteSuplier/${idSuplier}`);
    setOpen(false);
    refetch();
  };
    ...
    <Box flex={5}>
      ...
      <Container>
        ...
        >
          ...
          >
            {suplier?.length !== 0 ? (
              <Paper align="center" sx={{ maxWidth: "100%" }}>
                <div className={cssModules.listItem}>
                  <div>
                    <CgUserList />
                  </div>
                  <span className={cssModules.h5}>Suplier list</span>
                </div>
                <Table
                  sx={{ width: "100%" }}
                ...
                >
                  <TableHead>
                    <TableRow>
                      <TableCell>Suplier Code</TableCell>
